...
public class Introduction {
	...
	public static void main(String[] args) {
		...
		/*
		 *  driver.getCurrentUrl() helps to validate if we are landed in correct url and prevents 
		 *  from being redirected to some other hacked website.
		*/
		 ...
		 * So one can get the page source directly by right clicking on the website, but some websites disable the option of right clicks.
		 */
