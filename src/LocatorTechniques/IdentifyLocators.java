...
public class IdentifyLocators {
	...
	public static void main(String[] args) {
		...
		//driver.findElement(By.id("username")).sendKeys("dhiddi01"); // this line enters the data at this "username" locator with key as "dhiddi01"
		...
		// What if the multiple inspected elements have the same ID. This results in the considering the first object, even if we are intended to the second one's
		...
		//outer html copy is  <input type="password" class="inputtext _55r1 _6luy" name="pass" id="pass" data-testid="royal_pass" placeholder="Password" aria-label="Password">
