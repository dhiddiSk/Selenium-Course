...
public class MakeMyTripBookingAutomation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Explicit wait has been choosen in order to make the webdriver only to wait at certain points
		...
		//check if the element is present. If there are no elements present then it must return the empty list.
		
		boolean elementPresent = driver.findElements(By.xpath("//*[@id=\'SW\']/div[1]/div[1]/ul/li[6]/div[3]")).size() > 0;
		...
		boolean webAddPresent = driver.findElements(By.id("webklipper-publisher-widget-container-notification-container")).size() >0;
		...
		enterDetails(driver, wait);
		
}
	
	
  private static void enterDetails(WebDriver driver, WebDriverWait wait) throws InterruptedException{
